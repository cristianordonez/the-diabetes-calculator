    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    if (!req.query) return [3, 3];
                    return [4, apiHelpers.getSpoonacularRecipes(query)];
                case 2:
                    recipes = _a.sent();
                    res.send(recipes);
                    _a.label = 3;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4, apiHelpers.getSpoonacularRecipeById(params.id)];
                case 2:
                    recipeInfo = _a.sent();
                ...
                case 3:
                    err_2 = _a.sent();
                    console.log('err in get recipe by id', err_2);
