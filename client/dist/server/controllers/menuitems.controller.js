    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4, apiHelpers.getSpoonacularMenuItems(query)];
                case 2:
                    menuItems = _a.sent();
...
var getMenuItemById = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var params, menuItemInfo, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    params = req.params;
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4, apiHelpers.getSpoonacularMenuItemById(params.id)];
                case 2:
                ...
                case 3:
                    err_2 = _a.sent();
                    console.log('err in get menu item by id', err_2);
